...
public class FileManagement {
    ...
    //Rotina  feita para ver quais CNPJs tiveram problema com a atualizaç&#225;o do NFGoiana - Problema da vers&#225;o 1.2.0
    ...
    public static String getHashMD5(File arquivo) throws FileNotFoundException, IOException, NoSuchAlgorithmException {
        ...
        try {
            ...
            try {
                ...
                throw new RuntimeException("N&#225;o foi possível fechar o arquivo para o calculo do Hash", e);
            }
        }
    }
