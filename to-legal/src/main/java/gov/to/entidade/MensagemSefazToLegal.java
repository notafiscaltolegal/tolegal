...
@Entity
@Table(name = "tb_msg_sefaz")
public class MensagemSefazToLegal extends EntidadeBasica{
	...
	@Id
	@GeneratedValue(generator = "seq_msg_sefaz", strategy = GenerationType.IDENTITY)
	@SequenceGenerator(name = "seq_msg_sefaz", sequenceName = "seq_msg_sefaz",allocationSize=1)
	@Column(name = "id_msg_sefaz")
	private Long id;
	...
	@Enumerated(EnumType.STRING)
	private DestinatarioEnum destinatario;
	
	public MensagemSefazToLegal() {
	...
	public DestinatarioEnum getDestinatario() {
		return destinatario;
	}

	public void setDestinatario(DestinatarioEnum destinatario) {
