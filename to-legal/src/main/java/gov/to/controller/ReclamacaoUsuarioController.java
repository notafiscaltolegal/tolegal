...
public class ReclamacaoUsuarioController extends BaseController{
	...
	public @ResponseBody Map<String, Object> listarAndamentoReclamacao(@PathVariable(value = "page") Integer page,
			Integer idReclamacao, BindException bind) throws ParseException {
		Integer max = 5;

		PessoaParticipante cidadao = getCidadaoLogado();
		PaginacaoDTO<ReclamacaoLogDTO> reclamacoesPaginate = reclamacaoLogToLegalService
				.logReclamacaoPorIdReclamacao(idReclamacao, page, max);
