...
function Cidadao(options) {
    ...
    if (mensagemErroAtivacaoCadastro != "" && mensagemErroAtivacaoCadastro != null){
    	
    	nfgMensagens.show(ALERT_TYPES.ERROR, mensagemErroAtivacaoCadastro);
    }

    if (mensagemSucessoAtivacaoCadastro != "" && mensagemSucessoAtivacaoCadastro != null){
...
Cidadao.prototype.chamaPreValidadorDeCadastro = function(dataGenPessoaFisica){
    ...
    if (dataGenPessoaFisica.nomeDaMae == null || dataGenPessoaFisica.nomeDaMae == ''){
    	nfgMensagens.show(ALERT_TYPES.ERROR,"O nome da mãe é obrigatório.");
    	return false;
    }
    
    if (dataGenPessoaFisica.nomeDaMae.split(" ").length < 2){
    	nfgMensagens.show(ALERT_TYPES.ERROR,"O nome da mãe deve ter no mínimo dois nomes!");
    	return false;
    }
    
    if (dataGenPessoaFisica.dataDeNascimento == null){
    	nfgMensagens.show(ALERT_TYPES.ERROR,"A data de nascimento é obrigatório.");
    	return false;
    }
        ...
        ajaxBloqueioDeTela(
            ...
            function(response) {
                if(!response.cepInvalido){
                    ...
                    me.carregaUFMunicipios(response.nomeUf, response.ibgeMunicipio);
                }else{
...
Cidadao.prototype.fluxoDeTelaNovaReclamacao = function(){
    ...
    $("body").on("click", ".radioMotivoReclamacao", function() {
        ...
        $( "#tooltipIEReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_ie_b.png" />' });
        $( "#tooltipDataReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_data_b.png" />' });
        $( "#tooltipNumeroReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_nro_b.png" />' });
        $( "#tooltipValorReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_valor_b.png" />' });
    ...
    $("body").on("click", ".radioTipoDocReclamacao", function() {
        ...
        if($(this).val()== notaFiscal){
            ...
            $( "#tooltipDataReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_data_b.png" />' });
            $( "#tooltipNumeroReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_nro_b.png" />' });
            $( "#tooltipDataReclamacao" ).tooltip({ content: '<img src="/to-legal/images/nf_valor_b.png" />' });
            ...
            $("#tooltipNumeroReclamacao").css("display", "block");
            $("#tooltipValorReclamacao").css("display", "block");
            $( "#tooltipIEReclamacao" ).tooltip({ content: '<img src="/to-legal/images/cf_ie_b.png" />' });
            $( "#tooltipDataReclamacao" ).tooltip({ content: '<img src="/to-legal/images/cf_data_b.png" />' });
            $( "#tooltipNumeroReclamacao" ).tooltip({ content: '<img src="/to-legal/images/cf_coo_b.png" />' });
            $( "#tooltipValorReclamacao" ).tooltip({ content: '<img src="/to-legal/images/cf_valor_b.png" />' });
        }
    });
}
