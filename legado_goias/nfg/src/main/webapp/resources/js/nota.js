...
Nota.prototype.salvarNota = function(){
    ...
    //{
    //   nfgMensagens.show(ALERT_TYPES.ERROR, "Data de Emissão Inválida!");
    //   return;
    //}
...
Nota.prototype.msgModalHabilitacaoBotaoIncluir = function(){
    ...
    if( $('#selectTipoDocumentoFiscal option').eq('0').prop('selected')){
        self.confirmModal = new ConfirmModal(title,"Para habilitar o botão de inclusão preencha o Número do documento e a Data de emissão.",elementoVazio,buttonOk);
    }else{
        self.confirmModal = new ConfirmModal(title,"Para habilitar o botão de inclusão preencha o Número do documento, a Série <br/> e a Data de emissão.",elementoVazio,buttonOk);
    }
