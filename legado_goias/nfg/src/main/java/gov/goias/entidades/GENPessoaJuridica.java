...
@Entity
@Table(name = "GEN_PESSOA_JURIDICA")
...
public class GENPessoaJuridica extends GENPessoa implements Serializable {
    ...
    @JoinColumn(name = "NUMR_CNPJ_BASE", nullable = false)
    private GENEmpresa empresa;
    ...
    public GENEmpresa getEmpresa() {
        return empresa;
    }

    public void setEmpresa(GENEmpresa empresa) {
