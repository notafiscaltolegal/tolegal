...
public enum TipoComplSituacaoReclamacao {
    ...
    SISTEMA_NAO_ACHOU_NOVO_ARQUIVO(8,"Busca de novo arquivo não achou: notificar empresa","Sistema não achou novo arquivo enviado pela empresa. Aguardando resposta do usuário gestor do programa."),
    CIDADAO_CONCORDOU_COM_EMPRESA(9,"Concordar com resposta da empresa e finalizar reclamação","Cidadão concordou com a empresa."),
    CIDADAO_NAO_CONCORDOU_COM_EMPRESA(10,"Recusar resposta da empresa","Cidadão não concordou com a empresa. Aguardando resposta do usuário gestor do programa."),
    CIDADAO_CANCELOU_RECLAMACAO(11,"Cancelar a reclamação","Reclamação cancelada pelo cidadão."),
    USUARIO_NOTIFICOU_ERRO_EMPRESA(12,"Acionar fiscalização e notificar empresa","Usuário gestor do programa acionou fiscalização e notificou empresa."),
    USUARIO_NOTIFICOU_ERRO_CIDADAO(13,"Notificar cidadão que reclamação não procede","Usuário gestor do programa notificou cidadão."),
    ...
    EMPRESA_ESTA_DENTRO_DO_PRAZO(16,"Marcar reclamaçao como dentro do prazo legal para recebimento","A empresa ainda está dentro do prazo legal para envio do documento reclamado.");
