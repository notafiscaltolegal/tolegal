...
public enum TipoMotivoReclamacao {
    DOCUMENTO_NAO_CONSTA_NO_PORTAL(1,"Documento com CPF não consta no painel Minhas Notas do Portal do Cidadão"),
    EMPRESA_NAO_PERGUNTOU(2,"Empresa não perguntou se eu desejava incluir o CPF na nota/cupom fiscal"),
    ...
    EMPRESA_ALEGOU_NAO_PARTICIPAR(6,"Empresa alegou não participar do programa NFGoiana");
