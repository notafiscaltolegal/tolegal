...
public class DTOContribuinte implements Serializable {
    ...
    public Date getDataLimite() {
        if(this.dataObrigatoriedadeCnae == null) return null;

        if (this.dataCredenciamento != null)
           return contribuinteService.getDataLimite(this.dataObrigatoriedadeCnae, this.dataCredenciamento);
        else
           return contribuinteService.getDataLimite(this.dataObrigatoriedadeCnae);
    }
    ...
    public Boolean getPodeAlterar() {
        return contribuinteService.podeAlterarData(getDataLimite(), this.dataEfetivaParticipacao);
    }
