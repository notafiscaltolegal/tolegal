...
public class DTOValidacaoTrocaCnae implements Serializable{
    ...
    private void definaMensagem() {
        if(usuarioParticipante && !cnaeParticipante) mensagem = "CNAE não autorizado. O contribuinte será descadastrado do NFG";
        if(!usuarioParticipante && cnaeParticipante) mensagem = "Contribuinte não cadastrado no NFG e CNAE participante do NFG.";
    }
