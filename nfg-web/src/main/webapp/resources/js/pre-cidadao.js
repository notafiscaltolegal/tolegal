...
//            "<p class='text-justify' style='margin-top: 10px !important;'>&#8226; O cidad&#225;o deverá aguardar o recebimento de e-mail com a confirmaç&#225;o do pré-cadastro contendo senha para acesso à sua área restrita no site do To Legal;</p>" +
//            "<p class='text-justify' style='margin-top: 10px !important;'>&#8226; Depois do recebimento de e-mail com a validaç&#225;o do pré-cadastro, o cidad&#225;o deverá acessar o site do programa e, no menu “Cidad&#225;o”, informar seu CPF e a senha enviada anteriormente para o seu e-mail. Após realizado o login, deverá complementar as informações cadastrais solicitadas para ter acesso completo às funcionalidades do programa (Perfil, Consulta Notas, Placar, Pontuaç&#225;o, Bilhetes, Sorteio e Resgate de Prêmios);</p>"+
//            "<p class='text-justify' style='margin-top: 10px !important;'>Nota 1: O cidad&#225;o somente estará apto a concorrer aos prêmios se os dados informados forem validados.</p>"+
//            "<p class='text-justify' style='margin-top: 10px !important;'>Nota 2: A inserç&#225;o das notas fiscais emitidas com CPF ser&#225;o efetivadas diretamente pelas empresas. </p>";
//        var buttons = "<button class='btn btn-primary' style='margin-right: 50px' data-dismiss='modal'' aria-label='Fechar'>Fechar</button>";
//        var modal = new GenericModal("Termo Acordo Cidad&#225;o", textoAcordo, buttons);
//        modal.open();
//    });
//};
